...
function populateFullName() {
    fetch('https://condor-right-partially.ngrok-free.app/api/auth/session-data-client')
...
function fetchTestimonials(targetId) {
    fetch('https://condor-right-partially.ngrok-free.app/api/auth/accepted-testimonials')
        .then(response => response.json())
        .then(testimonials => {
